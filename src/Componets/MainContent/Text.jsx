...
function Text() {
    ...
    const textInfo = [
        {
            textMe: "Lorem ipsum dolar sit general sac "
        },
        {
            textYOU: "Lorem ipsum dolar sit general sac"
        },
        {
            textYOU: " ipsum dolar sit general issues "
        },
        {
            textMe: "Lorem ipsum dolar sit general sac"
        },
  ...
  return (
    <>
        <section className='bg-[#F4F4F5] h-[475px]'>
             ...
             <h4 className='bg-green-500 h-16 text-2xl flex justify-center items-center font-bold text-white mb-4 '>Chat with Ai</h4>
            {textInfo.map((pr, i) => (
                <div key={i}>
