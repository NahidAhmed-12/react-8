  ...
  return (
    <>
        <section> 
          <NavDown>
              <div>
                  <p className='text-gray-700'>beck</p>
                ...
                <div  className='flex gap-5 flex-col md:flex-row items-center'>
                  ...
                  <div className='NavinputDi flex gap-3 bg-white w-[190px] rounded-md border-1 py-[12px] px-[10px] items-center;'>
                    ...
                    <button className='"bg-primary py-2 px-6 rounded-md bg-green-500 text-white shadow-md hover:shadow-gray-500 hover:bg-secondary hover:text-black transition-all duration-300"'>Cypher AI</button>
                </div>
          </NavDown>
              ...
              { isactiv === true &&  <Text />}
                 <div className='flex md:justify-end md:items-end justify-center h-[200px]   md:h-[480px]'>
                   <button onClick={open} className=''>
                     {isactiv === false ? <p className='text-content'>c</p> : <i class="fa-solid fa-xmark text-2xl text-content"></i>}
                   </button>
                 </div>
              </div>
              </div>
